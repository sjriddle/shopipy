...
test: lint        ## Run tests and generate coverage report.
	$(ENV_PREFIX)pytest -v --cov-config .coveragerc --cov=shopipy -l --tb=short --maxfail=1 tests/
...
release:          ## Create a new tag for release.
	...
	@echo "$${TAG}" > shopipy/VERSION
	@$(ENV_PREFIX)gitchangelog > HISTORY.md
	@git add shopipy/VERSION HISTORY.md
...
switch-to-poetry: ## Switch to poetry package manager.
	...
	@echo "shopipy = 'shopipy.__main__:main'" >> pyproject.toml
	...
	@echo "Please run 'poetry shell' or 'poetry run shopipy'"
